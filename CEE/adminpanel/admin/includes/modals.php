        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="School" id="School">
              ...
              <option value="URBAN DAY GRAMMAR SCHOOL">URBAN DAY GRAMMAR SCHOOL</option>
              <option value="CHRIST ANGLICAN SECONDARY SCHOOL">CHRIST ANGLICAN SECONDARY SCHOOL</option>
              <option value="ADEGBAI SCHOOL">ADEGBAI SCHOOL</option>
              <option value="ALARERE SCHOOL">ALARERE SCHOOL</option>
              <option value="ALARERE SCHOOL">OGUNGBADE COMMUNITY SCHOOL 1</option>
            </select>
          </div>
          <div class="form-group">
            <label>Email</label>
